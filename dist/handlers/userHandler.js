...
function createUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var unHashedPassword, jwtPayload;
        return __generator(this, function (_a) {
            ...
            bcrypt_1["default"].hash(unHashedPassword, Number(process.env.SALT_ROUNDS), function (err, hash) {
                ...
                // generate token
                jsonwebtoken_1["default"].sign(JSON.stringify(jwtPayload), process.env.JWT_PRIVATE_KEY, function (err, token) { return __awaiter(_this, void 0, void 0, function () {
                    var createDetails, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (err) {
                                    console.log(err);
                                    return [2 /*return*/, res.status(400).json({ error: "unable to create user" })];
                                }
                                createDetails = {
                                    username: req.body.username,
                                ...
                                return [4 /*yield*/, user_1["default"].create(createDetails)];
                            case 1:
                                result = _a.sent();
                                console.log(result);
                                if (result.error) {
